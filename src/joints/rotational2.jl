...
@inline g(joint::Rotational2, body1::Body, body2::Body, Δt, No) = joint.V12 * (VLᵀmat(joint.qoff) * Lᵀmat(getq3(body1, Δt)) * getq3(body2, Δt))
...
@inline g(joint::Rotational2, body1::Origin, body2::Body, Δt, No) = joint.V12 * VLᵀmat(joint.qoff) * getq3(body2, Δt)
