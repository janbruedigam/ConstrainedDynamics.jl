...
@inline function ∂g∂ᵣposa(joint::Rotational3, body1::Body, body2::Body)
...
@inline function ∂g∂ᵣposb(joint::Rotational3, body1::Body, body2::Body)
    if body2.id == joint.childid
...
@inline function ∂g∂ᵣposb(joint::Rotational3, body1::Origin, body2::Body)
    if body2.id == joint.childid
