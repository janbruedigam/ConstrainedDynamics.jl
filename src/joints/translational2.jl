...
function minimalCoordinates(joint::Translational2, body1::Body, body2::Body, Δt, No)
...
@inline function minimalCoordinates(joint::Translational2, body1::Origin, body2::Body, Δt, No)
    vertices = joint.vertices
