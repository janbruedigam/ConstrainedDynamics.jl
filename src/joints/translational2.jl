...
function setForce!(joint::Translational2, body1::AbstractBody, body2::Body, F::SVector{0,T}, No) where T
    return
end

function setForce!(joint::Translational2, body1::AbstractBody, body2::Body, F::Nothing, No)
    return
end
...
function minimalCoordinates(joint::Translational2, body1::Body, body2::Body, No)
