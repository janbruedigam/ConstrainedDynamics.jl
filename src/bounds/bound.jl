...
@inline function ∂g∂ʳpos(bound::Bound, x::AbstractVector, q::QuatRotation)
    X, Q = ∂g∂pos(bound, x, q)
    Q = Q * LVᵀmat(q)
...
# Derivatives accounting for quaternion specialness
@inline function ∂g∂ʳvel(bound::Bound, x2::AbstractVector, q2::QuatRotation,
        x1::AbstractVector, v1::AbstractVector, q1::QuatRotation, ω1::AbstractVector, Δt
    )
