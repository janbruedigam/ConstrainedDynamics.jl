@inline getbody(mechanism::Mechanism, id::Int) = mechanism.bodies[id]
...
@inline geteqconstraint(mechanism::Mechanism, id::Int) = mechanism.eqconstraints[id]
...
@inline getineqconstraint(mechanism::Mechanism, id::Int) = mechanism.ineqconstraints[id]
...
function getcomponent(mechanism::Mechanism, id::Int)
