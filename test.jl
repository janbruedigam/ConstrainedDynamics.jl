...
setInit!(origin,link3,[1;1],q=q3,F=[0.,0.,0.])

link4 = Link{6}(m2,J2,vert2)
setInit!(link3,link4,[2;1],q=q4)

# Constraints
joint0to1 = Constraint(Socket(origin,link1,1,1),Axis(origin,link1,ex))
joint1to23 = Constraint(Socket(link1,link2,2,1),Axis(link1,link2,ex),SocketYZ(link1,link3,1,1))
joint1to2 = Constraint(Socket(link1,link2,2,1),Axis(link1,link2,ex))
joint1to3 = Constraint(Socket(link1,link3,1,1),Axis(link1,link3,ex))

joint3to4 = Constraint(Socket(link3,link4,2,1),Axis(link3,link4,ex))
joint2to4 = Constraint(Socket(link2,link4,2,2),Axis(link2,link4,ex))
