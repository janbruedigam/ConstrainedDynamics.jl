...
function transtest3()
    ...
    res = ForwardDiff.jacobian(x -> ForwardDiff.jacobian(testfoo, x)*[E Z34 Z3 Z34;Z43 LVᵀmat(x[]) Z43 Z4;Z3 Z34 I Z34;Z43 Z4 Z43 LVᵀmat(x[])], 
            [getxqkvector(body1.state);getxqkvector(body2.state);pa;pb]
        )
    ...
    n11 = norm(X1 - ∂g∂ʳpos(mech, joint1, 1)[1:3,1:3])
    n12 = norm(Q1 - ∂g∂ʳpos(mech, joint1, 1)[1:3,4:6])
    n21 = norm(X2 - ∂g∂ʳpos(mech, joint1, 2)[1:3,1:3])
    n22 = norm(Q2 - ∂g∂ʳpos(mech, joint1, 2)[1:3,4:6])
    ...
    n31 = norm(V1 - ∂g∂ʳvel(mech, joint1, 1)[1:3,1:3])
    n32 = norm(W1 - ∂g∂ʳvel(mech, joint1, 1)[1:3,4:6])
    n41 = norm(V2 - ∂g∂ʳvel(mech, joint1, 2)[1:3,1:3])
    n42 = norm(W2 - ∂g∂ʳvel(mech, joint1, 2)[1:3,4:6])
...
function transtest2()
    ...
    n11 = norm(X1 - ∂g∂ʳpos(mech, joint1, 1)[1:2,1:3])
    n12 = norm(Q1 - ∂g∂ʳpos(mech, joint1, 1)[1:2,4:6])
    n21 = norm(X2 - ∂g∂ʳpos(mech, joint1, 2)[1:2,1:3])
    n22 = norm(Q2 - ∂g∂ʳpos(mech, joint1, 2)[1:2,4:6])
    ...
    n31 = norm(V1 - ∂g∂ʳvel(mech, joint1, 1)[1:2,1:3])
    n32 = norm(W1 - ∂g∂ʳvel(mech, joint1, 1)[1:2,4:6])
    n41 = norm(V2 - ∂g∂ʳvel(mech, joint1, 2)[1:2,1:3])
    n42 = norm(W2 - ∂g∂ʳvel(mech, joint1, 2)[1:2,4:6])
...
function transtest1()
    ...
    n11 = norm(X1 - ∂g∂ʳpos(mech, joint1, 1)[1:3]')
    n12 = norm(Q1 - ∂g∂ʳpos(mech, joint1, 1)[4:6]')
    n21 = norm(X2 - ∂g∂ʳpos(mech, joint1, 2)[1:3]')
    n22 = norm(Q2 - ∂g∂ʳpos(mech, joint1, 2)[4:6]')
    ...
    n31 = norm(V1 - ∂g∂ʳvel(mech, joint1, 1)[1:3]')
    n32 = norm(W1 - ∂g∂ʳvel(mech, joint1, 1)[4:6]')
    n41 = norm(V2 - ∂g∂ʳvel(mech, joint1, 2)[1:3]')
    n42 = norm(W2 - ∂g∂ʳvel(mech, joint1, 2)[4:6]')
