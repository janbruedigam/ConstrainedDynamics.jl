...
@inline function g(joint::GenericJoint, xb::AbstractVector, qb::QuatRotation)
    a=5
    b=2
    ...
    qα = QuatRotation(cos(α/2),sin(α/2),0,0,false)
...
setPosition!(link1,x=[0;0.0;2],q = QuatRotation(RotX(0)))
