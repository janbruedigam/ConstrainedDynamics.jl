...
# Constraints
joint0to12 = Constraint(Cylindrical(origin,link1,zeros(3),vert11,ey),Spherical(origin,link2,zeros(3),vert11))
joint1to2 = Constraint(Cylindrical(link1,link2,zeros(3),zeros(3),ex))
